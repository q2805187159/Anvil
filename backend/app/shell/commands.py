...
COMMAND_REGISTRY: tuple[ShellCommandDef, ...] = (
    ...
    ShellCommandDef("memory", "Show HCMS overview or stores", "Capability", action="memory.overview"),
    ShellCommandDef("memory-engine", "List HCMS engines", "Capability", action="memory.engines", args_hint="[engine_id]"),
    ...
    ShellCommandDef(
        "setup",
        "Show or apply first-run setup, including required HCMS Git token config",
        "Config",
        args_hint="[--git-token-env ENV --git-token TOKEN]",
        action="config.setup",
    ),
