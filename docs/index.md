...
This is the top-level navigation page for the release-facing Anvil documentation set.

## Start Here

- [`README.md`](https://github.com/q2805187159/Anvil/blob/main/README.md)
...
- [`adr/ADR-001-architecture-baseline-and-extension-policy.md`](./adr/ADR-001-architecture-baseline-and-extension-policy.md)
- [`adr/ADR-002-v1-protocol-deferral-and-upgrade-seam.md`](./adr/ADR-002-v1-protocol-deferral-and-upgrade-seam.md)
- [`adr/ADR-003-execution-control-and-capability-truth.md`](./adr/ADR-003-execution-control-and-capability-truth.md)

## Operator and Developer Guides

- [`guides/usage.md`](./guides/usage.md)
- [`guides/quickstart-and-startup-modes.md`](./guides/quickstart-and-startup-modes.md)
- [`guides/deployment.md`](./guides/deployment.md)
...
- [`guides/local-docker-workspace.md`](./guides/local-docker-workspace.md)
...
- [`backend/tests/README.md`](https://github.com/q2805187159/Anvil/blob/main/backend/tests/README.md)
- [`frontend/README.md`](https://github.com/q2805187159/Anvil/blob/main/frontend/README.md)
