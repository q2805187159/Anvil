  ...
  return {
    ...
    useMemoryLayers: () => ({
      data: [
        ...
        { layer_id: "workspace", display_name: "HCMS Workspace", description: "Global work context.", writable: true, entry_count: 0, store_id: "hcms_workspace", summary: "workspace" },
      ],
    }),
    useMemoryOverview: () => ({ data: { active_engine_id: "hcms", store_count: 1, archive_turn_count: 0, reflection_job_count: 0, stores: [] }, refetch: vi.fn(), isFetching: false }),
