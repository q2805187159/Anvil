...
- Public releases exclude unreviewed local `skills/` packs; share reviewed
  skills through Anvil Home, examples, plugins, or a dedicated package.
...
- Do not commit local runtime state, IDE files, caches, internal future notes,
  unreviewed local skill packs, debug screenshots, or secrets.
